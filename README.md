...
[![Version](https://img.shields.io/badge/version-10.1.7-blue.svg)](https://cocoapods.org/pods/Mobilisten)
...
# SalesIQ Mobilisten  iOS SDK 10.1.7-beta
...
target 'Project Target' do
  use_frameworks!
  pod 'MobilistenBeta', '10.1.7-beta'
  pod 'Mobilisten-Calls-Beta', '1.1.2-beta'
end
```
