...
[![Version](https://img.shields.io/badge/version-10.3.4-blue.svg)](https://cocoapods.org/pods/Mobilisten)
...
# SalesIQ Mobilisten  iOS SDK 10.3.4-beta
...
target 'Project Target' do
  use_frameworks!
  pod 'MobilistenBeta', '10.3.4-beta'
  pod 'Mobilisten-Calls-Beta', '1.2.1-beta'
end
```
