...
[![Version](https://img.shields.io/badge/version-10.0.5-blue.svg)](https://cocoapods.org/pods/Mobilisten)
...
# SalesIQ Mobilisten  iOS SDK 10.0.5-beta
...
target 'Project Target' do
  use_frameworks!
  pod 'MobilistenBeta', '10.0.4-beta'
  pod 'Mobilisten-Calls-Beta', '1.0.4-beta'
end
```
