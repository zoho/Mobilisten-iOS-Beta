...
- (UIViewController * _Nullable)getStageController SWIFT_WARN_UNUSED_RESULT;
@end
...
/// This API allows you to disable the tracking functionlaity.
/// <h2>Usage Example</h2>
/// \code
/// ZohoSalesIQ.disableTracking()
///
/// \endcode
+ (void)disableTracking;
/// This API allows you to enable the tracking functionlaity.
/// <h2>Usage Example</h2>
/// \code
/// ZohoSalesIQ.enableTracking()
///
/// \endcode
+ (void)enableTracking;
...
- (void)debugLogWithDebugInfo:(NSString * _Nonnull)debugInfo;
@end
