...
/// This component used to show/hide audio messages
  ChatComponentVoicemessage = 11,
/// This component is used to enable/disable using camera to capture media
  ChatComponentFileshare = 12,
};
...
SWIFT_CLASS("_TtC10Mobilisten20SIQAudioMessageTheme")
@interface SIQAudioMessageTheme : NSObject
@property (nonatomic, strong) UIColor * _Null_unspecified thumbColor;
@property (nonatomic, strong) UIColor * _Null_unspecified seekBarColor;
@property (nonatomic, strong) UIColor * _Null_unspecified playerTimeColor;
@property (nonatomic, strong) UIColor * _Null_unspecified actionButtonColor;
@property (nonatomic, strong) UIColor * _Null_unspecified actionButtonIconColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) UIColor * _Null_unspecified moreIconBackgroundColor;
@property (nonatomic, strong) UIColor * _Null_unspecified sendIconBackgroundColor;
...
@property (nonatomic, strong) UIColor * _Null_unspecified tertiaryTextColor;
@property (nonatomic, strong) UIColor * _Null_unspecified openStatusColor;
@property (nonatomic, strong) UIColor * _Null_unspecified unreadCountBackgroundColor;
@property (nonatomic, strong) UIColor * _Null_unspecified unreadCountTextColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) UIColor * _Null_unspecified startChatButton;
@property (nonatomic, strong) UIColor * _Null_unspecified startChatButtonTitleColor;
@property (nonatomic, strong) UIColor * _Null_unspecified messageTextColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) UIColor * _Null_unspecified secondaryTextColor;
@property (nonatomic, strong) UIColor * _Null_unspecified tertiaryTextColor;
@property (nonatomic, strong) UIColor * _Null_unspecified likesSeperatorColor;
@property (nonatomic, strong) UIColor * _Null_unspecified likesIconColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) UIColor * _Null_unspecified outgoingSenderNameColor;
@property (nonatomic, strong) UIColor * _Null_unspecified outgoingTimeTextColor;
@property (nonatomic, strong) UIColor * _Null_unspecified incommingBackgroundColor;
@property (nonatomic, strong) UIColor * _Null_unspecified incommingTextColor;
@property (nonatomic, strong) UIColor * _Null_unspecified incommingBorderColor;
@property (nonatomic, strong) UIColor * _Null_unspecified incommingSenderNameColor;
@property (nonatomic, strong) UIColor * _Null_unspecified incommingTimeTextColor;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, strong) SIQAudioMessageTheme * _Nonnull AudioMessage;
@property (nonatomic, strong) SIQSkipActionButtonTheme * _Nonnull SkipActionButton;
@property (nonatomic, strong) UIColor * _Null_unspecified outgoingComponentTintColor;
@property (nonatomic, strong) UIColor * _Null_unspecified incommingComponentTintColor;
